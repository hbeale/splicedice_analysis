# make a tiny dataset for testing: chr1:1-10M
...
samtools view -b /mnt/output/star_2.7.11b_2024.12.13/${i}/sortedByCoord.md.bam 1:1-10000000 >/mnt/data/bams/${i}/${i}.${pos_name}.bam
done
