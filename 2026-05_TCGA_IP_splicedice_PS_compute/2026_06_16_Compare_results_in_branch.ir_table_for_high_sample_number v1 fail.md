# 2026_06_16_Compare_results_in_branch.ir_table_for_high_sample_number - v1 - fail



Most of the code in this is from "2026_06_11_Compare_splicedice_multi-sample_and_single_sample_approaches.md"

Jump to Generate ir from before "ir_table_for_high_sample_number" to see new code

this failed because the negative strand fix was not included 

repeat with updated "ir_table_for_high_sample_number" code for multi-sample approach
...
after_loc=/mnt/splicedice_ir_example_archives/multi_sample_3a6b2b0_2026.06.15_16.48.07/
...
are the headings in the same order? no
...
```bash
1c1
< Junction      TCGA-86-8074-01A        TCGA-62-8402-01A        TCGA-86-8358-01A        TCGA-86-8056-01A        TCGA-78-7158-01A
---
...
re-order the columns and check if things are the same after that

## are the column names the same after sorting? -yes

this compares colun names and the first row
...
## are thr first 1000 rows different? yes
...
47928 /mnt/splicedice_ir_example_archives/multi_sample_3a6b2b0_2026.06.15_16.48.07//analysis/_intron_retention.tsv
